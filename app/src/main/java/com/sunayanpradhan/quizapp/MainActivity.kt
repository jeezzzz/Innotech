...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionsList.add(QuestionModel("What is the largest planet in our solar system?","Earth","Mars","Jupiter","Saturn","Jupiter"))
        questionsList.add(QuestionModel("Which planet is known for its prominent rings?","Venus","Uranus","Neptune","Saturn","Saturn"))
        questionsList.add(QuestionModel("The apparent movement of the Sun is overhead the Equator twice a year on:","Dec 22 and Mar21","Mar21 and Sep23","Jun 21 and Dec 22","Sep 23 and Dec22","Mar21 and Sep23"))
        questionsList.add(QuestionModel("Which celestial body is considered a dwarf planet?","Pluto","Moon","Mercury","Sun","Pluto"))
        questionsList.add(QuestionModel("Which of the following part of the Sun is visible at the time of the eclipse?","Photosphere","Corona","Chromosphere","Core","  Corona"))
